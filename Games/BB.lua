...
local Window = Parvus.Utilities.UI:Window({Name = "Parvus Hub — " .. Parvus.Current,Enabled = Parvus.Config.UI.Enabled,Color = Parvus.Utilities.Config:TableToColor(Parvus.Config.UI.Color),Position = UDim2.new(0.2,-248,0.5,-248)}) do
    local AimAssistTab = Window:Tab({Name = "Aim Assist"}) do
        local AimbotSection = AimAssistTab:Section({Name = "Aimbot",Side = "Left"}) do
            ...
            AimbotSection:Dropdown({Name = "Target Part",Default = Parvus.Config.AimAssist.Aimbot.Priority,List = {"Head","Neck","Chest","Abdomen","Hips"},Callback = function(String)
        ...
        local SilentAimSection = AimAssistTab:Section({Name = "Silent Aim",Side = "Right"}) do
            ...
            SilentAimSection:Dropdown({Name = "Target Part",Default = Parvus.Config.AimAssist.SilentAim.Priority,List = {"Head","Neck","Chest","Abdomen","Hips"},Callback = function(String)
...
local function TeamCheck(Target)
    ...
    (Parvus.Config.AimAssist.TeamCheck and tostring(Target.Team) == "FFA")
end
...
local function GetTarget(FoV,Priority,WallCheckEnabled)
    ...
    for Index, Target in pairs(PlayerService:GetPlayers()) do
        ...
        if Target ~= LocalPlayer and Hitbox and TeamCheck(Target) then
            ...
            if OnScreen and WallCheck(WallCheckEnabled,Hitbox,Target.Character) and FieldOfView > Magnitude then
